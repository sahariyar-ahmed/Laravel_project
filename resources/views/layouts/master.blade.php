            ...
            <div class="header-area ">
                ...
                <div class="logo">
                    <a href="{{ route('frontend') }}">
                        <img src="{{ asset('frontend') }}/assets/img/logo/logo-dark.png" alt=""
                            class="logo-dark">
                ...
                <div class="header-navbar">
                    <nav class="navbar">
                        ...
                        <div class="collapse navbar-collapse" id="main_nav">
                            <ul class="navbar-nav ">
                                <li class="nav-item ">
                                    <a class="nav-link {{ Route::currentRouteName() == 'frontend' ? 'active' : '' }} "
                                        href="{{ route('frontend') }}"> Home </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  {{ Route::currentRouteName() == 'frontend.blogs' ? 'active' : '' }} "
